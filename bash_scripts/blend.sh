...
ffmpeg -i "$1" -i "$2" -c:v prores -profile:v 3 -filter_complex '[1:v]format=gbrp10le[v1];[0:v]format=gbrp10le[v0];[v1][v0]scale2ref[v1][v0];[v0][v1]blend=all_mode='$3',format=yuv422p10le [out]' -map '[out]' "${1%%.*}_blend_${3}.mov"
